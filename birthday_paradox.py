...
Explore the surprising probabilities fo the "Birthday Paradox".
More infor at https://en.wikipedia.org/wiki/Birthday_problem
...
print('Generating', num_b_days, 'random birthdays 100,00 times...')
...
print('matching birhday in that group', sim_match, 'times. This means')
print('that', num_b_days, 'people have a', probability, '% chance of')
print('having a matching birthday in their group.')
print('That\'s probably more than you would think!')

print((datetime.date(2023, 6, 7)) + datetime.timedelta(2))
