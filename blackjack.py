"""Blackjack, by Al Swigart al@inventwithpython.com
...
def main():
    ...
    Rules:
        ...
        but must hit exactly one more time vefore standing.
...
def get_hand_value(cards):
    ...
    for card in cards:
        rank = card[0]  # card is a tuble like (rank, suit)
        if rank == 'A':
            number_of_aces += 1
...
# If the program is run (instead of imported), run the games:
